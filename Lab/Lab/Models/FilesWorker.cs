...
namespace FilesBack.Models
{
    public class FilesWorker
    {
        DataContext DataBase = new DataContext(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\Avgusta\Desktop\oauthserver_lab2-master\Live_com\Live_com\App_Data\Database2.mdf;Integrated Security=True");
        ...
        public File DeleteFile(int file_id, int user_id)
        {
            Table<File> Files = DataBase.GetTable<File>();
